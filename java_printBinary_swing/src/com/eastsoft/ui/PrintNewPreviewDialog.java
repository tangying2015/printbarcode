 ...
 */
public class PrintNewPreviewDialog extends JDialog implements ActionListener {
	...
	public PrintNewPreviewDialog(MainUI mainJUI,Frame parent, String title, boolean modal,
			MyPrint mp) {
	...
	private void setLayout() {
		...
		jButton_printPreviewCloseButton.setText("\u5173\u95ed");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (src == jButton_printPreviewCloseButton) {
			...
			String deviceID=mainJUI.getNewDeviceID();
			String devicePassword=mainJUI.getNewDevicePassword();
			String deviceSSID=mainJUI.getNewDeviceSSID();
			mainJUI.productNewQRCode(deviceID, devicePassword, deviceSSID);
			mainJUI.printNewBinaryPicture();
		}
