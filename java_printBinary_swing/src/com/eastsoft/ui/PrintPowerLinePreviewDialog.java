 ...
 */
public class PrintPowerLinePreviewDialog extends JDialog implements ActionListener {
	...
	public PrintPowerLinePreviewDialog(MainUI mainJUI,Frame parent, String title, boolean modal,
			MyPrint mp) {
		super(parent, "电力线设备"+title, modal);
	...
	private void setLayout() {
		...
		jButton_printPreviewCloseButton.setText("关闭");	//预览窗口的关闭
		...
		jButton_printPreviewCloseButton.setSize(100, 45);
		{
			...
			jButton_printPreviewPrintLabel.setText("打印");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (src == jButton_printPreviewCloseButton) {
			...
			String deviceID=mainJUI.powerLineAdapterPanel.getDeviceID();
			String deviceSN=mainJUI.powerLineAdapterPanel.getDeviceSN();
			String manageIP=mainJUI.powerLineAdapterPanel.getManageIP();
			//mainJUI.powerLineAdapterPanel.productPowerLineQRCode(deviceID, deviceSN, manageIP);
			mainJUI.powerLineAdapterPanel.printBinaryPicture();
		}
	}
